...
export class SettingService {
  ...
  getUser(id: string | null) {
    return this.http.get<{ user: User }>(environment.api_url + 'auth/users/' + id)
  }
  ...
  editStatusCategory(id: string, data: any) {
    return this.http.put<any>(environment.api_url + 'category/active/' + id, data)
  }
  ...
  changeActiveBrand(id: string, data: any) {
    return this.http.put<any>(environment.api_url + 'brands/active/' + id, data)
  }

  addSubCategory(data: ISubCategory) {
    return this.http.post<any>(environment.api_url + 'subcategory', data)
  }

  updateSubCategoryById(id: string, data: any) {
    return this.http.put<any>(environment.api_url + id, data)
  }

  updateStatusSubCategory(id: string, data: any) {
    return this.http.put<any>(environment.api_url + 'subcategory/active/' + id, data)
  }
}
